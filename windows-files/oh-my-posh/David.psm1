...
function Write-Theme {
	...
	#add custom name
	if($sl.PromptSymbols.MySymbol -and $sl.PromptSymbols.MySymbol -ne "") {
		$prompt += Write-Prompt -Object "$($sl.PromptSymbols.MySymbol) " -ForegroundColor $sl.Colors.MyIconForegroundColor -BackgroundColor $sl.Colors.SessionInfoBackgroundColor
	}
